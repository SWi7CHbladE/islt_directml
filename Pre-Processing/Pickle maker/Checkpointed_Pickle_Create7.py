...
# Files to access
w_dest = "Dataset/excels/Train/Train_7.xlsx"
o_dest = "Dataset/Pickles/train_pickles/excel_data_7.train"
f_dest = "Dataset/Final folder for frames"
train_checkpoint_path = 'C:/Users/Admin/Rahul/islt_directml/Pre-Processing/Pickle maker/Dataset/Checkpoint/unstable/train_checkpoint_7.pkl'

create_pickle(w_dest, o_dest, f_dest, train_checkpoint_path)

print("Done creating pickle 7.")