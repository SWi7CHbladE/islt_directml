...
python -m signjowy train configs/24head/sign_24head_8batch.yaml && python -m signjoey train configs/24head/sign_24head_16batch.yaml && python -m signjoey train configs/24head/sign_24head_32batch.yaml && python -m signjoey train configs/24head/sign_24head_64batch.yaml && python -m signjoey train configs/24head/sign_24head_128batch.yaml && python -m signjoey train config/24head/sign_24head_256batch.yaml
