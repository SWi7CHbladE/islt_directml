...
train_checkpoint_path = 'C:/Users/Admin/Rahul/islt_directml/Pre-Processing/Pickle maker/Dataset/Checkpoint/unstable/train_checkpoint_3.pkl'

create_pickle(w_dest, o_dest, f_dest, train_checkpoint_path)



print("Done creating pickle 3.")