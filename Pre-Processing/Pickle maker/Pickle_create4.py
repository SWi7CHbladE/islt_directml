...
# Files to access:
# validation
vw_dest = "Dataset/excels/Sports_dataset/4/ISH_News_Sports final VAL.xlsx"
vo_dest = "/Dataset/Pickles/Sports_dataset/4/excel_data.dev"
vf_dest = "Dataset/Final folder for frames"

# test
tw_dest = "Dataset/excels/Sports_dataset/4/ISH_News_Sports final TEST.xlsx"
to_dest = "/Dataset/Pickles/Sports_dataset/4/excel_data.test"
tf_dest = "Dataset/Final folder for frames"

# train
w_dest = "Dataset/excels/Sports_dataset/4/ISH_News_Sports final TRAIN.xlsx"
o_dest = "/Dataset/Pickles/Sports_dataset/4/excel_data.train"
